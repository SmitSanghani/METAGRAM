...
const LeftSidebar = () => {
    ...
    return (
        <div className={`LeftSidebar fixed top-0 z-[100] left-0 w-[280px] h-screen bg-white border-r border-gray-200 hidden sm:flex flex-col justify-between pb-6 px-6 transition-all duration-300`}>
