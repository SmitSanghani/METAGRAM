...
const NotificationDropdown = ({ onClose }) => {
    ...
    return (
        <div className="fixed sm:absolute top-0 left-0 sm:left-full h-[100dvh] w-full sm:w-[360px] bg-white border-r border-l border-gray-200 shadow-[0_0_50px_rgba(0,0,0,0.1)] z-[200] flex flex-col animate-in fade-in slide-in-from-bottom sm:slide-in-from-left duration-300">
