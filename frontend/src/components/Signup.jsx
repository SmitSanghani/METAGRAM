    ...
    return (
        <AuthLayout>
            <form onSubmit={signupHandler} className="space-y-3">
                ...
                <div className="space-y-2">
                    <label className="text-[11px] font-bold text-gray-500 tracking-wider uppercase ml-1">GENDER</label>
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            type="button"
                            onClick={() => setInput({ ...input, gender: 'male' })}
                            className={`flex items-center justify-center gap-2 py-2.5 rounded-xl border transition-all ${input.gender === 'male' ? 'bg-[#32b096]/10 border-[#32b096] text-[#32b096]' : 'bg-[#1c1c1c] border-white/10 text-gray-400 hover:border-white/20'}`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 py-2.5 rounded-xl border transition-all ${input.gender === 'female' ? 'bg-[#32b096]/10 border-[#32b096] text-[#32b096]' : 'bg-[#1c1c1c] border-white/10 text-gray-400 hover:border-white/20'}`}
                        >
                    ...
                    {errors.gender && <p className="text-[10px] text-red-500 font-bold tracking-wide mt-1 ml-1 uppercase">{errors.gender}</p>}
                </div>
